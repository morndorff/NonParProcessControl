...
f_out_control <- Find_CL_CVM_Pval_DWindow_OOC

# TEMPORARY
method <- "doublewindow"
lambdas = c(.3, .5, .7) # double window change
...
if(method=="doublewindow"){
save(data.results, tstat, method, ARL, m, M, W_vec, file=save_name)
}else{
